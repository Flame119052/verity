...
- [x] Claude, Codex, and Antigravity status surfaces, install/login commands, and provider-specific invocation paths are exercised with deterministic fixtures. Clean third-party accounts are deliberately not a release dependency. Evidence: provider unit and subprocess harness checks plus packaged-app walkthrough, 2026-07-16.
...
- [x] Version/build are 2.0.0/20000 and native release notes are final for the recommended zero-cost release profile.
...
- [x] DMG layout, Applications link, checksum verification, and removal documentation pass. Evidence: final release gate and `SHA256SUMS`, 2026-07-16.
